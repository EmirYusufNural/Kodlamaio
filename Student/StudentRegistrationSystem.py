class OgrenciKayitSistemi:
    ...
    def ogrenci_listele(self):
        i = 0  # sayaç değişkeni
        while i < len(self.ogrenciler):  # sayaç değişkeni öğrenci listesinin uzunluğunu geçene kadar döngü devam edecek
                ogrenci = self.ogrenciler[i]
                print(f"{ogrenci['numara']}: {ogrenci['isim']} {ogrenci['soyisim']}")
                i += 1  # sayaç değişkeni arttırılıyor       
